...
namespace TopologyDdcci
{
    namespace AnchorDisplay
    {
        /// <summary>
        /// A display mode exposed by the invisible topology anchor.
        /// </summary>
        struct AnchorMode
        {
            DWORD Width;
        ...
        /// <summary>
        /// Owns the single indirect display adapter and monitor.
        /// </summary>
